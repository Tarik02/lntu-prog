...
int main() {
	...
	// Функцiя int putchar(const char *s) друкує один символ
	// зi стрiчки s
	cout << "Посимвольний друк стручки s:" << endl << "  ";
	for (i = 0; i < len; ++i) {
		putchar(s[i]);
	}
	cout << endl;
	...
	cout << "Друк всієї стрічки s відразу і перевід курсора на початок нової стрічки:" << endl << "  ";
	puts(s);
