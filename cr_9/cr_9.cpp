...
/*  Мова: C++                                               */
/*                                                          */
/*  Створити базовий та похідні класи, на базі класу,       */
/* створеного у попередньому завданні. Передбачити, що      */
/* базовий клас виконуватиме функції введення масиву        */
/* структур, а похідний клас – функції обробки масиву       */
/* структур.                                                */
...
patient_t PatientInput::input_patient() {
	patient_t result;
